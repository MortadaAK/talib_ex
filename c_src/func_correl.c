...
ex_correl(ErlNifEnv *env, int argc, const ERL_NIF_TERM argv[])
{
  ...
  if (!enif_is_list(env, argv[0]))
  {
    ...
    return enif_make_tuple2(env, atoms->atom_error, enif_make_string(env, "values0 should be a list", ERL_NIF_LATIN1));
  }
  ...
  if (tmpLen == 0)
  {
    ...
    return enif_make_tuple2(env, atoms->atom_error, enif_make_string(env, "values0 is an empty list", ERL_NIF_LATIN1));
  }
    ...
    if (input0 != NULL)
  {
    ...
    return enif_make_tuple2(env, atoms->atom_error, enif_make_string(env, "values1 should be a list", ERL_NIF_LATIN1));
  }
      ...
      if (input0 != NULL)
  {
    ...
    return enif_make_tuple2(env, atoms->atom_error, enif_make_string(env, "values1 is a list with different length", ERL_NIF_LATIN1));
  }
  ...
  if (input0 != NULL)
  {
    ...
    return enif_make_tuple2(env, atoms->atom_error, enif_make_string(env, "time_period should be an integer", ERL_NIF_LATIN1));
  }
  enif_get_int(env, argv[2], &input2);
