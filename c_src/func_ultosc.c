...
ex_ultosc(ErlNifEnv *env, int argc, const ERL_NIF_TERM argv[])
{
  ...
  if (input0 != NULL)
  {
    ...
    return enif_make_tuple2(env, atoms->atom_error, enif_make_string(env, "time_period1 should be an integer", ERL_NIF_LATIN1));
  }
  ...
  if (input0 != NULL)
  {
    ...
    return enif_make_tuple2(env, atoms->atom_error, enif_make_string(env, "time_period2 should be an integer", ERL_NIF_LATIN1));
  }
  ...
  if (input0 != NULL)
  {
    ...
    return enif_make_tuple2(env, atoms->atom_error, enif_make_string(env, "time_period3 should be an integer", ERL_NIF_LATIN1));
  }
