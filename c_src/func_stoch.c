...
ex_stoch(ErlNifEnv *env, int argc, const ERL_NIF_TERM argv[])
{
  ...
  if (argc != 8)
  {
    return enif_make_tuple2(env, atoms->atom_error, enif_make_string(env, "should be called with 8", ERL_NIF_LATIN1));
  }
  ...
  if (input0 != NULL)
  {
    ...
    return enif_make_tuple2(env, atoms->atom_error, enif_make_string(env, "fast_k_period should be an integer", ERL_NIF_LATIN1));
  }
  ...
  if (input0 != NULL)
  {
    ...
    return enif_make_tuple2(env, atoms->atom_error, enif_make_string(env, "slow_k_period should be an integer", ERL_NIF_LATIN1));
  }
  enif_get_int(env, argv[4], &input4);

  load_moving_average_type(argv[5], atoms, &input5);
  ...
  if (input0 != NULL)
  {
    ...
    return enif_make_tuple2(env, atoms->atom_error, enif_make_string(env, "slow_d_period should be an integer", ERL_NIF_LATIN1));
  }
  enif_get_int(env, argv[6], &input6);

  load_moving_average_type(argv[7], atoms, &input7);
