...
ex_mavp(ErlNifEnv *env, int argc, const ERL_NIF_TERM argv[])
{
    ...
    if (input0 != NULL)
  {
    ...
    return enif_make_tuple2(env, atoms->atom_error, enif_make_string(env, "periods should be a list", ERL_NIF_LATIN1));
  }
      ...
      if (input0 != NULL)
  {
    ...
    return enif_make_tuple2(env, atoms->atom_error, enif_make_string(env, "periods is a list with different length", ERL_NIF_LATIN1));
  }
  ...
  if (input0 != NULL)
  {
    ...
    return enif_make_tuple2(env, atoms->atom_error, enif_make_string(env, "min_period should be an integer", ERL_NIF_LATIN1));
  }
  ...
  if (input0 != NULL)
  {
    ...
    return enif_make_tuple2(env, atoms->atom_error, enif_make_string(env, "max_period should be an integer", ERL_NIF_LATIN1));
  }
